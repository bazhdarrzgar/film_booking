...
$query = mysqli_query($conn,"SELECT * FROM seats WHERE user_id = '2' AND movie_id = '$temp_mov_id' AND date_time = '$combinedDT'");
...
VALUES('$temp_mov_id', '2', '$combinedDT', '$seat_select')";
