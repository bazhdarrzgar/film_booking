...
include('navbar1.html');
    ...
    //Sql Query 
    $coll = "SELECT count(user_id) from seats";
    //Execute Query
    $res_coll = mysqli_query($conn_1, $coll);
    //Count Rows
    $temp_seat_id = mysqli_num_rows($res_coll);
...
//   $temp_seat_id = $magic_session['total'];
...
$sql1 = "SELECT no_snack FROM snacks WHERE seat_id = '1'";
...
$sql2 = "SELECT snack_amt AS snacksamt FROM snacks WHERE seat_id = '1'";
