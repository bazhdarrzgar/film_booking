  ...
  <div id="Admin">
    ...
    <div class="container-admin">
      ...
      <div class="right">
        ...
        <div class="mid-right">
        <button style="margin-top: 600px; width: 200px; height: 50px; margin-right: 200px" type="button" name="button" class="button button5"><a href="search/user_search.php" style="text-decoration:none; font-size: 18px; font-weight: bold">Find User</a></button>
        </div>
